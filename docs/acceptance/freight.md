# Freight analysis acceptance specification

## Outcome

For RailAnukriti, freight paths, stoppages and throughput remain measurable.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the freight analysis workflow,
