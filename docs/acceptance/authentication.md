# Authentication acceptance specification

## Outcome

For RailAnukriti, authorised controllers can sign in, restore a session and sign out safely.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the authentication workflow,
