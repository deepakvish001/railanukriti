# Conflict detection acceptance specification

## Outcome

For RailAnukriti, overlapping or incompatible movements are prioritised and explainable.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the conflict detection workflow,
