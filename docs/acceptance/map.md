# Map view acceptance specification

## Outcome

For RailAnukriti, train positions display freshness, identity and safe missing-token behaviour.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the map view workflow,
