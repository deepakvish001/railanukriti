# Delay predictions acceptance specification

## Outcome

For RailAnukriti, predictions expose horizon, confidence, inputs and stale-data state.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the delay predictions workflow,
