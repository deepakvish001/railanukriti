# Audit history acceptance specification

## Outcome

For RailAnukriti, controller actions are immutable, searchable and time-ordered.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the audit history workflow,
