# Scenario simulation acceptance specification

## Outcome

For RailAnukriti, what-if inputs remain isolated from live operational data.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the scenario simulation workflow,
