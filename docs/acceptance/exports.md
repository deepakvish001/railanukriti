# Operational exports acceptance specification

## Outcome

For RailAnukriti, authorised users export constrained, spreadsheet-safe data.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the operational exports workflow,
