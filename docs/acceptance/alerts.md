# Operational alerts acceptance specification

## Outcome

For RailAnukriti, critical events are visible, acknowledgeable and auditable.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the operational alerts workflow,
