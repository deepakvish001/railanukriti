# Infrastructure analysis acceptance specification

## Outcome

For RailAnukriti, capacity scenarios expose assumptions and reversible comparisons.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the infrastructure analysis workflow,
