# Recommendations acceptance specification

## Outcome

For RailAnukriti, controllers can review rationale, confidence and override suggestions.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the recommendations workflow,
