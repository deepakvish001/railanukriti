# Operations dashboard acceptance specification

## Outcome

For RailAnukriti, controllers can understand section state, freshness and critical conditions.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the operations dashboard workflow,
