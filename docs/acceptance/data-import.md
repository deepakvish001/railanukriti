# Data import acceptance specification

## Outcome

For RailAnukriti, invalid train and timetable records are rejected with row-level feedback.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the data import workflow,
