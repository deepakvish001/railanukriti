...
This guide defines the error handling for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers validation failures, network errors, provider outages and user-safe recovery. It applies to new features, maintenance changes and production operations.
