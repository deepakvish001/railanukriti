...
This guide defines the operational data model for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers trains, sections, schedules, conflicts, recommendations and audit records. It applies to new features, maintenance changes and production operations.
