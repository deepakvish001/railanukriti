...
This guide defines the accessibility standard for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers keyboard navigation, alert semantics, charts, colour, motion and control-room use. It applies to new features, maintenance changes and production operations.
