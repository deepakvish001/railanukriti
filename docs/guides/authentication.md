...
This guide defines the authentication flow for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers sign-in, session restoration, protected routes and sign-out behaviour. It applies to new features, maintenance changes and production operations.
