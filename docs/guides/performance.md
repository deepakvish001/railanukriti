...
This guide defines the performance budget for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers dashboard loading, query efficiency, map rendering, charts and bundle size. It applies to new features, maintenance changes and production operations.
