...
This guide defines the logging guidance for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers structured events, correlation, redaction, retention and operational investigation. It applies to new features, maintenance changes and production operations.
