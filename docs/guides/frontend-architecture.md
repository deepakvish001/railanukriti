...
This guide defines the frontend architecture for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers routing, providers, dashboard modules, shared state and component boundaries. It applies to new features, maintenance changes and production operations.
