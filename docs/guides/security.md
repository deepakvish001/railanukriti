...
This guide defines the security baseline for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers client threats, database policies, credential handling and dependency security. It applies to new features, maintenance changes and production operations.
