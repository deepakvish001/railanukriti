...
This guide defines the supabase setup for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers project creation, authentication, schema, row-level security and local configuration. It applies to new features, maintenance changes and production operations.
