...
This guide defines the observability design for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers health signals, latency, stale data, alert delivery and service-level indicators. It applies to new features, maintenance changes and production operations.
