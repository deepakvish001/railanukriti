...
This guide defines the authorization model for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers controller roles, record access, administrative operations and default-deny rules. It applies to new features, maintenance changes and production operations.
