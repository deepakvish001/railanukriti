...
This guide defines the release process for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers versioning, change review, production checks and rollback ownership. It applies to new features, maintenance changes and production operations.
