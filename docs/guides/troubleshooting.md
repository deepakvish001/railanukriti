...
This guide defines the troubleshooting handbook for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers Vite, Supabase, Mapbox, authentication, stale queries and production builds. It applies to new features, maintenance changes and production operations.
