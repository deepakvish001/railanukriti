...
This guide defines the system context for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers actors, trust boundaries, external services and operational responsibilities. It applies to new features, maintenance changes and production operations.
