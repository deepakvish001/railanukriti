...
This guide defines the testing strategy for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers unit, component, integration, end-to-end and simulation validation layers. It applies to new features, maintenance changes and production operations.
