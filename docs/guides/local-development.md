...
This guide defines the local development workflow for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers installation, startup, debugging, code checks and common recovery steps. It applies to new features, maintenance changes and production operations.
