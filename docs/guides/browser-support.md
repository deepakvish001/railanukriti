...
This guide defines the browser support for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers supported platforms, responsive control-room layouts and progressive enhancement. It applies to new features, maintenance changes and production operations.
