...
This guide defines the environment configuration for **RailAnukriti**, a railway traffic optimisation and controller decision support application.

## Scope

The guidance covers browser-safe variables, secret handling, validation and deployment overrides. It applies to new features, maintenance changes and production operations.
